...
*/
  ...
  function updatePosition() {
    if ( pookachu.direction === "right") {
      if(pookachu.xPosition < boundaries.xAxis.max) {
        pookachu.xPosition += 1;
      } else {
        pookachu.direction = "left"
      }
    } else if ( pookachu.direction === "left") {
      if(pookachu.xPosition > boundaries.xAxis.min){
        pookachu.xPosition -= 1;
      }else{
        pookachu.direction = "right";
      }
    } else if ( pookachu.direction === "down") {
      if(pookachu.yPosition < boundaries.yAxis.max) {
        pookachu.yPosition += 1;
      } else {
        pookachu.direction = "up";
      }
    }  else if ( pookachu.direction === "up") {
      if(pookachu.yPosition > boundaries.yAxis.min) {
        pookachu.yPosition -= 1;
      } else {
        pookachu.direction = "down";
      }
    }
  }
